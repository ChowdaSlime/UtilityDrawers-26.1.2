...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ModBlocks.FILING_CABINET.get());
        this.tag(BlockTags.NEEDS_STONE_TOOL).add(ModBlocks.FILING_CABINET.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ModBlocks.CRAFTING_STORAGE_VIEWER.get());
        this.tag(BlockTags.NEEDS_STONE_TOOL).add(ModBlocks.CRAFTING_STORAGE_VIEWER.get());
    }
}
