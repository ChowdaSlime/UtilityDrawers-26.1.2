...
public class FramedCompactingDrawerItemModel implements ItemModel {
    ...
    static {
        try {
            ...
            throw new RuntimeException("FramedCompactingDrawerItemModel: failed to reflect ItemStackRenderState fields", e);
        }
    }

    public FramedCompactingDrawerItemModel(ItemModel baseModel) {
        ...
        try {
            ...
            for (int i = 0; i < activeCount; i++) {
                ...
                for (BakedQuad quad : originalQuads) {
                    ...
                    if (frameSprite != null && path.equals("block/framed_compacting_drawer")) {
                        quadList.add(remapQuad(quad, oldSprite, frameSprite));
                    } else if (faceSprite != null && path.equals("block/framed_compacting_drawer_face")) {
