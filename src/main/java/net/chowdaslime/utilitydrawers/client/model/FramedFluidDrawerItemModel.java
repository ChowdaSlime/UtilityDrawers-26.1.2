...
public class FramedFluidDrawerItemModel implements ItemModel {
    ...
    static {
        try {
            ...
            throw new RuntimeException("FramedFluidDrawerItemModel: failed to reflect ItemStackRenderState fields", e);
        }
    }

    public FramedFluidDrawerItemModel(ItemModel baseModel) {
