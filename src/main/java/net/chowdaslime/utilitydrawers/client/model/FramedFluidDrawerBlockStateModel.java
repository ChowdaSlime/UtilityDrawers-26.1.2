...
import net.chowdaslime.utilitydrawers.block.entity.FramedFluidDrawerBlockEntity;
...
public class FramedFluidDrawerBlockStateModel implements BlockStateModel {

    private final BlockStateModel originalModel;

    public FramedFluidDrawerBlockStateModel(BlockStateModel originalModel) {
    ...
    public void collectParts(BlockAndTintGetter level, BlockPos pos, BlockState state, RandomSource random, List<BlockStateModelPart> parts) {
        ...
        BlockState frameState = data.get(FramedFluidDrawerBlockEntity.FRAME_PROPERTY);
        BlockState faceState = data.get(FramedFluidDrawerBlockEntity.FACE_PROPERTY);
    ...
    private static @Nullable TextureAtlasSprite getSpriteFromBlockState(BlockState state, Direction targetDir) {
        ...
        if (blockModel instanceof FramedFluidDrawerBlockStateModel framed) {
