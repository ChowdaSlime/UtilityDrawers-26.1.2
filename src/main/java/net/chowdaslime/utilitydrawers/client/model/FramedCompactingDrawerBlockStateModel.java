package net.chowdaslime.utilitydrawers.client.model;
...
public class FramedCompactingDrawerBlockStateModel implements BlockStateModel {

    private final BlockStateModel originalModel;

    public FramedCompactingDrawerBlockStateModel(BlockStateModel originalModel) {
    ...
    public void collectParts(BlockAndTintGetter level, BlockPos pos, BlockState state, RandomSource random, List<BlockStateModelPart> parts) {
        ...
        BlockState frameState = data.get(FramedCompactingDrawerBlockEntity.FRAME_PROPERTY);
        BlockState faceState = data.get(FramedCompactingDrawerBlockEntity.FACE_PROPERTY);
    ...
    private static @Nullable TextureAtlasSprite getSpriteFromBlockState(BlockState state, Direction targetDir) {
        ...
        if (blockModel instanceof FramedCompactingDrawerBlockStateModel framed) {
        ...
        return new BlockStateModelPart() {
            ...
            public List<BakedQuad> getQuads(@Nullable Direction dir) {
                ...
                for (BakedQuad quad : originalQuads) {
                    ...
                    if (frameSprite != null && texturePath.equals("block/framed_compacting_drawer")) {
                        newQuads.add(remapQuad(quad, oldSprite, frameSprite));
                    } else if (faceSprite != null && texturePath.equals("block/framed_compacting_drawer_face")) {
