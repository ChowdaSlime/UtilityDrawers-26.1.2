...
public class DrawerMenu extends AbstractContainerMenu {
    ...
    public DrawerMenu(int containerId, Inventory playerInventory, BlockEntity blockEntity) {
        this(ModMenuTypes.DRAWER_MENU.get(), containerId, playerInventory, blockEntity, true, true);
    }

    protected DrawerMenu(MenuType<?> type, int containerId, Inventory playerInventory, BlockEntity blockEntity,
    ...
    private static class UtilityUpgradeSlot extends Slot {
        ...
        public UtilityUpgradeSlot(SimpleContainer container, int index, int x, int y, DrawerBlockEntity blockEntity) {
    ...
    private static class TierUpgradeSlot extends Slot {
        ...
        public TierUpgradeSlot(SimpleContainer container, int index, int x, int y, DrawerBlockEntity blockEntity) {
            super(container, index, x, y);
            this.blockEntity = blockEntity;
        }
