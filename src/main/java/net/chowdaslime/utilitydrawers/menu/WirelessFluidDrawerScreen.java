...
import net.chowdaslime.utilitydrawers.network.UpdateWirelessFluidDrawerPayload;
...
public class WirelessFluidDrawerScreen extends FluidDrawerScreen<WirelessFluidDrawerMenu> {
    ...
    public WirelessFluidDrawerScreen(WirelessFluidDrawerMenu menu, Inventory playerInventory, Component title) {
    ...
    private void sendUpdatePacket() {
        ...
        ClientPacketDistributor.sendToServer(
                new UpdateWirelessFluidDrawerPayload(getWirelessMenu().getBlockPos(), newKey)
        );
    }
    ...
    public void extractContents(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        WirelessFluidDrawerMenu wMenu = getWirelessMenu();
    ...
    private String buildKeyPreview(WirelessFluidDrawerMenu menu) {
