...
public class ClientCompactingDrawerTooltipComponent implements ClientTooltipComponent {

    private final CompactingDrawerTooltipComponent drawerComponent;
    private static final int SLOT_SIZE = 20;

    public ClientCompactingDrawerTooltipComponent(CompactingDrawerTooltipComponent drawerComponent) {
