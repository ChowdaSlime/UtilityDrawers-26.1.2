...
public class CompactingDrawerRenderer implements BlockEntityRenderer<CompactingDrawerBlockEntity, CompactingDrawerRenderer.CompactingDrawerRenderState> {

    private final ItemModelResolver itemModelResolver;
    private final Font font;

    public CompactingDrawerRenderer(BlockEntityRendererProvider.Context context) {
        this.itemModelResolver = context.itemModelResolver();
        this.font = context.font();
    }

    public static class CompactingDrawerRenderState extends BlockEntityRenderState {
    ...
    @Override
    public void extractRenderState(CompactingDrawerBlockEntity blockEntity, CompactingDrawerRenderState state, float partialTick, Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
    ...
    @Override
    public void submit(CompactingDrawerRenderState state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState cameraRenderState) {
        ...
        try {
            ...
            float[][] slotOffsets = new float[][]{{0.0f, 0.26f, 0.4f}, {-0.24f, -0.18f, 0.4f}, {0.24f, -0.18f, 0.4f}};
            float[] itemScales = new float[]{0.45f, 0.45f, 0.45f};

            for (int i = 0; i < Math.min(slotCount, 3); i++) {
