...
import net.drawers.utilitydrawers.block.entity.FilingCabinetBlockEntity;
...
public class FilingCabinetMenu extends AbstractContainerMenu {
    ...
    private boolean matchesSearch(ItemStack stack) {
        ...
        if (searchText.startsWith("$")) {
            ...
            java.util.List<Component> lines = stack.getTooltipLines(Item.TooltipContext.EMPTY, null, TooltipFlag.Default.ADVANCED);
            return lines.stream()
